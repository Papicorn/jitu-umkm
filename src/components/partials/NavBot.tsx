            ...
            <div className="w-full fixed bottom-0 right-0 left-0 bg-[#FFCA40] shadow rounded-tl-2xl rounded-tr-2xl">
                <div className="grid grid-cols-4 text-zinc-700">
                    ...
                    <Link href="/produk/pos">
                        <div className={` ${ pathname.startsWith('/produk') ? 'bg-white shadow-inner' : '' } px-2 py-4 active:bg-[rgba(22,22,22,0.10)] rounded-tl-2xl rounded-tr-2xl`}>
                            <div className="flex-row text-center">
                                <div className="relative h-7 mb-2">
                    ...
                    <Link href="/laporan">
                    <div className={` ${ pathname.startsWith('/laporan') ? 'bg-white shadow-inner' : '' } px-2 py-4 active:bg-[rgba(22,22,22,0.10)] rounded-tl-xl rounded-tr-xl`}>
                        <div className="flex-row text-center">
                            <div className="relative h-7 mb-2">
